...
const DetailNewsPage = () => {
  return (
    <div className="w-full bg-white">
      <div className="py-[86px] gap-y-[60px] px-[70px] w-full max-w-[1440px] mx-auto flex flex-col">
        <section className="flex flex-col gap-y-[28px]">
          ...
          <span className="flex gap-5 items-center text-[20px]">
          ...
          <Image
            ...
            width={1300}
            height={624}
            className="w-[1300px] h-[624px] object-cover"
          />
          <p className="font-poppins font-[400] text-justify text-[24px]">
        ...
        <section>
          <div className="text-hitam-700 w-full justify-between flex items-center">
            <span>
              <h2 className="font-[700] text-[38px]">Related News</h2>
              <h3 className="font-[400] text-[16px]">
            ...
            <Link
              href="#"
              className="flex items-center gap-x-3 font-[500] text-[20px]"
            >
              Show More
              <BsArrowRight />
            </Link>
